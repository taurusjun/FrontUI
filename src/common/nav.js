...
export const getNavData = app => [
  {
    component: dynamicWrapper(app, ['user', 'login'], () => import('../layouts/FrontLayout')),
    layout: 'FrontLayout',
        ...
        children: [
          {
            ...
            component: dynamicWrapper(app, ['controller'], () => import('../routes/Controller/DepartmentAdminList')),
          },
          {
            name: '标准列表',
            path: 'basic-list',
